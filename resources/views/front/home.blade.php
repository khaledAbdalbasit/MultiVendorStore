                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider" style="background-image: url({{$product->image_url}});">
                                <div class="content">
                                    <h2><span>{{$product->price}}</span>
                                        {{$product->name}}

                                    </h2>
                                    <p>{{$product->description}}</p>
                                    <h3><span>Now Only</span> {{$product->price-$product->compare_price}}</h3>
                                    <div class="button">
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            <!-- Start Small Banner -->
                            <div class="hero-small-banner" style="background-image: url({{$product->image_url}});">
                                <div class="content">
                                    <h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="{{$product->image_url}}" alt="#" height="200">
                                    <div class="button">
                                        <a href="{{route('products.show',$product->slug)}}" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                                    </div>
                                </div>
                    ...
                    $count ++ ;
                    @endphp
                    <div class="single-banner right" style="background-image:url('{{$product->image_url}}');margin-top: 40px;">
                        <div class="content">
                            ...
                            <div class="button">
                                <a href="{{route('products.show',$product->slug)}}" class="btn"><i class="lni lni-cart"></i> shop now</a>
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <div class="offer-content">
                        ...
                        <div class="text">
                            <h2><a href="product-grids.html">{{$product->name}}</a></h2>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
