                            ...
                            <div class="mega-category-menu">
                                ...
                                <ul class="sub-category">
                                    ...
                                    <ul class="inner-sub-category">
                                        <li><a href="{{route('products.categories.show','Digital-Cameras')}}">Digital Cameras</a></li>
                                        <li><a href="{{route('products.categories.show2','accessories')}}">accessories</a></li>
                                        <li><a href="{{route('products.categories.show3','televisions')}}">Televisions</a></li>
                                        <li><a href="{{route('products.categories.show4','watch')}}">watch</a></li>
                                    </ul>
                                    </li>
